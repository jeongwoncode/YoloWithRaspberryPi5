...
def notebook_init(verbose=True):
    ...
    # Check if 'wandb' is installed, but don't attempt to uninstall it on Raspberry Pi
    if check_requirements("wandb", install=False):
        print("wandb is installed. Make sure it is configured correctly.")

    # Remove sample_data directory if running in Google Colab
    if is_colab():
